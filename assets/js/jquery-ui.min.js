                        ...
                        this.each(function () {
                            ...
                            'right' === n.my[0] ? (D.left -= h) : 'center' === n.my[0] && (D.left -= h / 2),
                                ...
                                t.each(['left', 'top'], function (e, i) {
                                    t.ui.position[w[e]] && t.ui.position[w[e]][i](D, { targetWidth: p, targetHeight: f, elemWidth: h, elemHeight: c, collisionPosition: s, collisionWidth: x, collisionHeight: C, offset: [u[0] + I[0], u[1] + I[1]], my: n.my, at: n.at, within: b, elem: l });
                                }),
                                n.using &&
                                    (r = function (t) {
                                        var e = g.left - D.left,
        ...
        t.ui.plugin.add('resizable', 'containment', {
            ...
            resize: function (e) {
                ...
                d[0] !== document && /static/.test(d.css('position')) && (u = l),
                    h.left < (a._helper ? l.left : 0) && ((a.size.width = a.size.width + (a._helper ? a.position.left - l.left : a.position.left - u.left)), c && ((a.size.height = a.size.width / a.aspectRatio), (p = !1)), (a.position.left = r.helper ? l.left : 0)),
                    h.top < (a._helper ? l.top : 0) && ((a.size.height = a.size.height + (a._helper ? a.position.top - l.top : a.position.top)), c && ((a.size.width = a.size.height * a.aspectRatio), (p = !1)), (a.position.top = a._helper ? l.top : 0)),
        ...
        _connectDatepicker: function (e, i) {
            ...
            (i.append = t([])),
                ...
                s.hasClass(this.markerClassName) ||
                    (this._attachments(s, i), s.addClass(this.markerClassName).on('keydown', this._doKeyDown).on('keypress', this._doKeyPress).on('keyup', this._doKeyUp), this._autoSize(i), t.data(e, 'datepicker', i), i.settings.disabled && this._disableDatepicker(e));
        },
            ...
            for (
                ...
                for (x = '', this.maxRows = 4, C = 0; U[1] > C; C++) {
                    ...
                    for (
                        ...
                        for (P += '<tr>', E = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, 'calculateWeek')(A) + '</td>' : '', w = 0; 7 > w; w++)
                            (W = m ? m.apply(t.input ? t.input[0] : null, [A]) : [!0, '']),
                                ...
                                (E +=
                                    ...
                                    (F && !_ ? '' : ' ' + W[1] + (A.getTime() === G.getTime() ? ' ' + this._currentClass : '') + (A.getTime() === B.getTime() ? ' ui-datepicker-today' : '')) +
                                    "'" +
            ...
            t.ui.formResetMixin,
            {
                ...
                _drawButton: function () {
                    ...
                    (this.labels = this.element.labels().attr('for', this.ids.button)),
                        ...
                        this.element.hide(),
                        (this.button = t('<span>', { tabindex: this.options.disabled ? -1 : 0, id: this.ids.button, role: 'combobox', 'aria-expanded': 'false', 'aria-autocomplete': 'list', 'aria-owns': this.ids.menu, 'aria-haspopup': 'true', title: this.element.attr('title') }).insertAfter(
                            this.element
                        )),
                ...
                (this.tablist = this._getList().attr('role', 'tablist')),
                    ...
                    this.anchors.each(function (i, s) {
                        ...
                        e._isLocal(s)
                            ...
                            : ((a = l.attr('aria-controls') || t({}).uniqueId()[0].id), (n = '#' + a), (o = e.element.find(n)), o.length || ((o = e._createPanel(a)), o.insertAfter(e.panels[i - 1] || e.tablist)), o.attr('aria-live', 'polite')),
            ...
            _eventHandler: function (e) {
                ...
                e.preventDefault(),
                    o.hasClass('ui-state-disabled') ||
                        ...
                        ((i.active = r ? !1 : this.tabs.index(o)), (this.active = a ? t() : o), this.xhr && this.xhr.abort(), h.length || l.length || t.error('jQuery UI Tabs: Mismatching fragment identifier.'), l.length && this.load(this.tabs.index(o), e), this._toggle(e, c));
            },
            ...
            (p.style.cssText = 'background-color:rgba(1,1,1,.5)'),
                ...
                (c.hsla.to = function (t) {
                    ...
                    var e,
                        ...
                        c = r + l,
                        u = 0.5 * c;
                    return (e = l === r ? 0 : s === r ? (60 * (n - o)) / h + 360 : n === r ? (60 * (o - s)) / h + 120 : (60 * (s - n)) / h + 240), (i = 0 === h ? 0 : 0.5 >= u ? h / c : h / (2 - c)), [Math.round(e) % 360, i, u, null == a ? 1 : a];
                }),
    ...
    t.effects.define('blind', 'hide', function (e, i) {
        ...
        t.effects.define('size', function (e, i) {
            ...
            t.effects.createPlaceholder(a),
                ...
                ('box' === d || 'both' === d) && (n.from.y !== n.to.y && ((_ = t.effects.setTransition(a, l, n.from.y, _)), (v = t.effects.setTransition(a, l, n.to.y, v))), n.from.x !== n.to.x && ((_ = t.effects.setTransition(a, h, n.from.x, _)), (v = t.effects.setTransition(a, h, n.to.x, v)))),
