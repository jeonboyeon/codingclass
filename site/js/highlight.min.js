...
var hljs = (function () {
        ...
        return (
            ...
            (function t(r, s) {
                ...
                return (
                    ...
                    s && (r.begin || (r.begin = /\B|\b/), (o.beginRe = n(o.begin)), r.end || r.endsWithParent || (r.end = /\B|\b/), r.end && (o.endRe = n(o.end)), (o.terminatorEnd = d(o.end) || ''), r.endsWithParent && s.terminatorEnd && (o.terminatorEnd += (r.end ? '|' : '') + s.terminatorEnd)),
    ...
    var ne = ((n) => {
        ...
        function f(e, n, i, r) {
            ...
            function b(e, n) {
                return (
                    ...
                    e.beginScope && (e.beginScope._wrap ? (M.addKeyword(S, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = '')) : e.beginScope._multi && (u(e.beginScope, n), (S = ''))),
                    (k = Object.create(e, {
                        parent: {
                            value: k,
                        },
            ...
            try {
                ...
                if (t.message && t.message.includes('Illegal')) return { language: e, value: J(n), illegal: !0, relevance: 0, _illegalBy: { message: t.message, index: C, context: n.slice(C - 100, C + 100), mode: t.mode, resultSoFar: O }, _emitter: M };
                if (s)
                    return {
                        language: e,
                        value: J(n),
        ...
        function y(e) {
            ...
            if (
                ...
                e.children.length > 0 &&
                    (d.ignoreUnescapedHTML || (console.warn('One of your code blocks includes unescaped HTML. This is a potentially serious security risk.'), console.warn('https://github.com/highlightjs/highlight.js/wiki/security'), console.warn('The element with unescaped HTML:'), console.warn(e)),
    ...
    function we(e) {
        ...
        const m = [].concat(u, l.contains),
            ...
            f = { relevance: 0, match: n.either(/\bJSON/, /\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/, /\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/, /\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/), className: 'title.class', keywords: { _: [..._e, ...he] } },
            E = {
                variants: [
                    {
    ...
    var Ue = Object.freeze({
            ...
            const n = e.regex,
                ...
                p = {
                    ...
                    contains: [
                        ...
                        { className: 'params', begin: /\(/, end: /\)/, keywords: g, relevance: 0, contains: [t, e.C_BLOCK_COMMENT_MODE, s, o, r, { begin: /\(/, end: /\)/, keywords: g, relevance: 0, contains: ['self', t, e.C_BLOCK_COMMENT_MODE, s, o, r] }] },
                        r,
                        t,
                        e.C_BLOCK_COMMENT_MODE,
                        l,
            ...
            return {
                ...
                contains: [
                    ...
                    },
                    {
                        ...
                        keywords: i,
                        contains: [{ className: 'params', begin: /\(/, end: /\)/, keywords: i, relevance: 0, contains: [r, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, ge, e.C_BLOCK_COMMENT_MODE] }, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
                    },
                    ge,
                    r,
                ],
        ...
        grmr_less: (e) => {
            ...
            const d = r.concat({
                ...
                u = {
                    ...
                    relevance: 0,
                    contains: [{ begin: /-(webkit|moz|ms|o)-/ }, n.CSS_VARIABLE, { className: 'attribute', begin: '\\b(' + oe.join('|') + ')\\b', end: /(?=:)/, starts: { endsWithParent: !0, illegal: '[<=$]', relevance: 0, contains: r } }],
                },
                b = { className: 'keyword', begin: '@(import|media|charset|font-face|(-[a-z]+-)?keyframes|supports|document|namespace|page|viewport|host)\\b', starts: { end: '[;{}]', keywords: l, returnEnd: !0, contains: r, relevance: 0 } },
                m = {
                    className: 'variable',
                    variants: [
            ...
            return i.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, b, m, _, u, p, g, n.FUNCTION_DISPATCH), { name: 'Less', case_insensitive: !0, illegal: '[=>\'/<($"]', contains: i };
        },
        grmr_lua: (e) => {
            const n = '\\[=*\\[',
                t = '\\]=*\\]',
        ...
        grmr_php: (e) => {
            const n = e.regex,
                ...
                w = { relevance: 0, match: [/\b/, n.concat('(?!fn\\b|function\\b|', p(u).join('\\b|'), '|', p(b).join('\\b|'), '\\b)'), a, n.concat(l, '*'), n.lookahead(/(?=\()/)], scope: { 3: 'title.function.invoke' }, contains: [y] };
            y.contains.push(w);
        ...
        grmr_typescript: (e) => {
            const n = we(e),
                ...
                r = { $pattern: be, keyword: me.concat(['type', 'namespace', 'interface', 'public', 'private', 'protected', 'implements', 'declare', 'abstract', 'readonly', 'enum', 'override']), literal: pe, built_in: ye.concat(t), 'variable.language': Ee },
