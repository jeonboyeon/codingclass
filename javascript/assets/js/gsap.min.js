...
!(function (t, e) {
        ...
        return (
            ...
            function (t, e, r) {
                ...
                if (!d) {
                    ...
                    for (d = y[c] = [], i = T ? Math.min(f, c) * w - 0.5 : m % f, n = f === N ? 0 : T ? (c * x) / f - 0.5 : (m / f) | 0, l = N, u = h = 0; u < c; u++)
    ...
    function fb(h, e) {
        var l,
            ...
            r = K(h);
        return (
            !r && v(h) && ((l = r = h.radius || N), h.values ? ((h = Ot(h.values)), (f = !t(h[0])) && (l *= l)) : (h = eb(h.increment))),
            Va(
                e,
                r
                    ? s(h)
    ...
    function xb(t, e, r) {
        return ((6 * (t += t < 0 ? 1 : 1 < t ? -1 : 0) < 1 ? e + (r - e) * t * 6 : t < 0.5 ? r : 3 * t < 2 ? e + (r - e) * (2 / 3 - t) * 6 : e) * Ct + 0.5) | 0;
    }
    function yb(e, r, i) {
        var n,
            a,
        ...
        if (!p) {
            if ((',' === e.substr(-1) && (e = e.substr(0, e.length - 1)), St[e])) p = St[e];
                ...
                } else (o = (+p[0] % 360) / 360), (u = p[1] / 100), (n = 2 * (h = p[2] / 100) - (a = h <= 0.5 ? h * (u + 1) : h + u - h * u)), 3 < p.length && (p[3] *= 1), (p[0] = xb(o + 1 / 3, n, a)), (p[1] = xb(o, n, a)), (p[2] = xb(o - 1 / 3, n, a));
            ...
            return r(e) && (isNaN(e) || e in o)
                ? ((a = e.charAt(0)),
                  ...
                  '<' === a || '>' === a
                      ...
                      : n < 0
                      ? (e in o || (o[e] = h), o[e])
                      : ((a = parseFloat(e.charAt(n - 1) + e.substr(n + 1))), s && i && (a = (a / 100) * (K(i) ? i[0] : i).totalDuration()), 1 < n ? _parsePosition(t, e.substr(0, n - 1), i) + a : h + a))
                : null == e
                ? h
                : +e;
        },
    ...
    function cn(t) {
        return t < Y ? X * t * t : t < 0.7272727272727273 ? X * Math.pow(t - 1.5 / 2.75, 2) + 0.75 : t < 0.9090909090909092 ? X * (t -= 2.25 / 2.75) * t + 0.9375 : X * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
    }
    ...
    var Xt,
        ...
        Vt =
                ...
                return arguments.length
                    ? (this._ps !== t &&
                          ((this._ps = t)
                              ...
                              : (Rt(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== q && (this._tTime -= q)))),
                      this)
                    : this._ps;
            }),
            ...
            (Xt.revert = function revert(t) {
                void 0 === t && (t = ht);
                var e = I;
                return (I = t), this.timeline && this.timeline.revert(t), this.totalTime(-0.01, t.suppressEvents), 'nested' !== this.data && ya(this), (I = e), this;
            }),
                    ...
                    this._onUpdate && !e && Pt(this, 'onUpdate', !0),
                        ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
                            ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                                this._lock ||
                                ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || ya(this, 1), e || (t < 0 && !_) || (!v && !_ && m) || (Pt(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
                }
                return this;
            }),
                ...
                if (a._dirty) {
                    for (i = a.parent; s; )
                        (e = s._prev),
                            ...
                            o < (r = s._start) && a._sort && s._ts && !a._lock ? ((a._lock = 1), (Ja(a, s, r - s._delay, 1)._lock = 0)) : (o = r),
    ...
    var Ut,
        ...
        qt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
            ...
            var c,
                ...
                _ = s(d) ? (l ? Kt : Zt) : Wt;
            if ((r(n) && (~n.indexOf('random(') && (n = nb(n)), '=' === n.charAt(1) && ((!(c = ja(p, n) + (Xa(p) || 0)) && 0 !== c) || (n = c))), !f || p !== n || Nt))
                return isNaN(p * n) || '' === n
                    ? (d || e in t || Q(e, n),
                      function _addComplexStringPropTween(t, e, r, i, n, a, s) {
                          ...
                          for (_.b = r, _.e = i, r += '', (d = ~(i += '').indexOf('random(')) && (i = nb(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || []; (o = it.exec(i)); )
                              (l = o[0]),
                                  ...
                                  l !== u[g++] && ((c = parseFloat(u[g - 1]) || 0), (_._pt = { _next: _._pt, p: f || 1 === g ? f : ',', s: c, c: '=' === l.charAt(1) ? ja(c, l) - c : parseFloat(l) - c, m: h && h < 4 ? Math.round : 0 }), (m = it.lastIndex));
                          return (_.c = m < i.length ? i.substring(m, i.length) : ''), (_.fp = s), (nt.test(i) || d) && (_.e = 0), (this._pt = _);
                      }.call(this, t, e, p, n, _, h || V.stringFilter, l))
                    : ((c = new me(this._pt, t, e, +p || 0, n - (p || 0), 'boolean' == typeof d ? ne : re, 0, _)), l && (c.fp = l), u && c.modifier(u, this, t), (this._pt = c));
        },
        jt = function _initTween(t, e) {
            ...
            if ((!E || (k && m) || (m = 'none'), (t._ease = Lt(m, U.ease)), (t._yEase = O ? Bt(Lt(!0 === O ? m : O, U.ease)) : 0), O && t._yoyo && !t._repeat && ((O = t._yEase), (t._yEase = t._ease), (t._ease = O)), (t._from = !E && !!_.runBackwards), !E || (k && !_.stagger))) {
                if (((d = (h = A[0] ? ea(A[0]).harness : 0) && _[h.prop]), (r = ta(_, lt)), S && (e < 0 && M && v && !P ? S.render(-1, !0) : S.revert(M && C ? ht : ut), (S._lazy = 0)), g)) {
                    if ((ya((t._startAt = $t.set(A, pa({ data: 'isStart', overwrite: !1, parent: D, immediateRender: !0, lazy: w(y), startAt: null, delay: 0, onUpdate: T, onUpdateParams: b, callbackScope: x, stagger: 0 }, g)))), e < 0 && (I || (!v && !P)) && t._startAt.revert(ht), v && C && e <= 0))
                        return void (e && (t._zTime = e));
                } else if (M && C && !S)
                    if ((e && (v = !1), (n = pa({ overwrite: !1, data: 'isFromStart', lazy: v && w(y), immediateRender: v, stagger: 0, parent: D }, r)), d && (n[h.prop] = d), ya((t._startAt = $t.set(A, n))), e < 0 && (I ? t._startAt.revert(ht) : t._startAt.render(-1, !0)), (t._zTime = e), v)) {
                        if (!e) return;
    ...
    var $t = (function (E) {
        function Tween(e, r, i, n) {
            ...
            if (((a._targets = C.length ? da(C) : R('GSAP target ' + e + ' not found. https://greensock.com', !V.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = b), x || T || y(_) || y(m))) {
                if (((r = a.vars), (s = a.timeline = new Qt({ data: 'nested', defaults: M || {}, targets: P && 'nested' === P.data ? P.vars.targets : C })).kill(), (s.parent = s._dp = _assertThisInitialized(a)), (s._start = 0), T || y(_) || y(m))) {
                    ...
                    if (K(x))
                        ...
                        for (l in u)
                            for (
                                ...
                                ((D = { ease: (A = S[o]).e, duration: ((A.t - (o ? S[o - 1].t : 0)) / 100) * _ })[l] = A.v), s.to(C, D, z), (z += D.duration);
        ...
        return (
                ...
                if (p) {
                    if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != _)) {
                        if (((i = m), (l = this.timeline), this._repeat)) {
                            ...
                            if (((i = ia(m % s)), m === d ? ((a = this._repeat), (i = p)) : ((a = ~~(m / s)) && a === m / s && ((i = p), a--), p < i && (i = p)), (u = this._yoyo && 1 & a) && ((f = this._yEase), (i = p - i)), (o = yt(this._tTime, s)), i === c && !r && this._initted))
                        ...
                        (l && l.render(t < 0 ? t : !i && u ? -q : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
                            ...
                            (m !== this._tDur && m) ||
                                ...
                                e || (_ && !c) || (!m && !c) || (Pt(this, m === d ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (m < d && 0 < this.timeScale()) || this._prom()));
                    }
                } else
            ...
            (e.resetTo = function resetTo(t, e, r, i) {
                ...
                return (
                    ...
                    (function _updatePropTweens(t, e, r, i, n, a, s) {
                        ...
                        : (Ha(this, 0), this.parent || wa(this._dp, this, '_first', '_last', this._dp._sort ? '_start' : 0), this.render(0))
                );
            }),
            (e.kill = function kill(t, e) {
                ...
                for (
                    ...
                    if (~c.indexOf(f[l])) for (u in ((a = d[l]), 'all' === e ? ((n[l] = e), (o = a), (s = {})) : ((s = n[l] = n[l] || {}), (o = e)), o)) (h = a && a[u]) && (('kill' in h.d && !0 !== h.d.kill(u)) || xa(this, h, '_pt'), delete a[u]), 'all' !== s && (s[u] = 1);
    ...
    ga(gt + 'parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger', function (t) {
        ...
        (B = new Qt({ sortChildren: !1, defaults: U, autoRemoveChildren: !0, id: 'root', smoothChildTiming: !0 })),
        (V.stringFilter = Db);
    function Bc(t) {
        ...
        return i === h || !u || dr[i] || dr[h]
            ...
            : ('px' === h || p || (u = Yd(t, e, r, 'px')),
              ...
              (!_ && '%' !== h) || (!er[e] && !~e.indexOf('adius'))
                  ...
                  : ((n = o ? t.getBBox()[f ? 'width' : 'height'] : t[d]), ha(_ ? (u / n) * 100 : (u / 100) * n)));
    }
    function $d(t, e, r, i) {
        if (!r || 'none' === r) {
            var n = cr(e, t, 1),
    ...
    function be(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            else for (n = (o = o.split(',')).length; -1 < --n; ) (r = o[n]), er[r] && ((i = 1), (r = 'transformOrigin' === r ? lr : hr)), Ud(a, r);
    ...
    function he(t, e) {
        ...
        return s.svg && t.getAttribute('transform')
            ...
            : (u !== vr ||
                  ...
                  t === De ||
                  s.svg ||
                  ((n = o.display), (o.display = 'block'), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), De.appendChild(t)), (u = ge(t)), n ? (o.display = n) : Ud(t, 'display'), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : De.removeChild(t))),
    ...
    function ie(t, e, r, i, n, a) {
        var s,
            ...
            x = parseFloat(b[1]) || 0;
        r
            ? l !== vr && (o = _ * v - m * g) && ((u = w * (-m / o) + x * (_ / o) - (_ * T - m * y) / o), (w = w * (v / o) + x * (-g / o) + (g * T - v * y) / o), (x = u))
            : ((w = (s = Sd(t)).x + (~b[0].indexOf('%') ? (w / 100) * s.width : w)), (x = s.y + (~(b[1] || b[0]).indexOf('%') ? (x / 100) * s.height : x))),
            ...
            (t.style[lr] = '0px 0px'),
            a && (Vd(a, h, 'xOrigin', f, w), Vd(a, h, 'yOrigin', c, x), Vd(a, h, 'xOffset', d, h.xOffset), Vd(a, h, 'yOffset', p, h.yOffset)),
    ...
    var Se,
        ...
        _r = function _get(t, e, r, i) {
            ...
            return (
                ...
                er[e] && 'transform' !== e
                    ? ((n = Tr(t, i)), (n = 'transformOrigin' !== e ? n[e] : n.svg ? n.origin : br(Md(t, lr)) + ' ' + n.zOrigin + 'px'))
                    : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) || (n = (gr[e] && gr[e](t, e, r)) || Md(t, e) || fa(t, e) || ('opacity' === e ? 1 : 0)),
            ...
            return (
                ...
                L.translate &&
                    (('none' === L.translate && 'none' === L.scale && 'none' === L.rotate) ||
                        (F[hr] = ('none' !== L.translate ? 'translate3d(' + (L.translate + ' 0 0').split(' ').slice(0, 3).join(', ') + ') ' : '') + ('none' !== L.rotate ? 'rotate(' + L.rotate + ') ' : '') + ('none' !== L.scale ? 'scale(' + L.scale.split(' ').join(',') + ') ' : '') + L[hr]),
                    (F.scale = F.rotate = F.translate = 'none')),
                (m = he(t, r.svg)),
                r.svg && ((k = r.uncache ? ((P = t.getBBox()), (X = r.xOrigin - P.x + 'px ' + (r.yOrigin - P.y) + 'px'), '') : !e && t.getAttribute('data-svg-origin')), ie(t, k || X, !!k || r.originIsAbsolute, !1 !== r.smooth, m)),
                (p = r.xOrigin || 0),
                (_ = r.yOrigin || 0),
                m !== vr &&
                    ((T = m[0]),
                    ...
                    (n = O = m[5]),
                    6 === m.length
                        ? ((s = Math.sqrt(T * T + b * b)), (o = Math.sqrt(x * x + w * w)), (u = T || b ? nr(b, T) * rr : 0), (f = w || x ? nr(w, x) * rr + u : 0) && (o *= Math.abs(Math.cos(f * ir))), r.svg && ((i -= p - (p * T + _ * w)), (n -= _ - (p * b + _ * x))))
                        : ((E = m[6]),
                          (z = m[7]),
                          (S = m[8]),
                          (A = m[9]),
                          ...
                          (a = m[14]),
                          (h = (g = nr(E, D)) * rr),
                          g && ((k = M * (v = Math.cos(-g)) + S * (y = Math.sin(-g))), (P = O * v + A * y), (C = E * v + D * y), (S = M * -y + S * v), (A = O * -y + A * v), (D = E * -y + D * v), (R = z * -y + R * v), (M = k), (O = P), (E = C)),
                          (l = (g = nr(-w, D)) * rr),
                          g && ((v = Math.cos(-g)), (R = x * (y = Math.sin(-g)) + R * v), (T = k = T * v - S * y), (b = P = b * v - A * y), (w = C = w * v - D * y)),
                          (u = (g = nr(b, T)) * rr),
                          g && ((k = T * (v = Math.cos(g)) + b * (y = Math.sin(g))), (P = M * v + O * y), (b = b * v - T * y), (O = O * v - M * y), (T = k), (M = P)),
                          ...
                          (d = R ? 1 / (R < 0 ? -R : R) : 0)),
                    r.svg && ((k = t.getAttribute('transform')), (r.forceCSS = t.setAttribute('transform', '') || !fe(Md(t, hr))), k && t.setAttribute('transform', k))),
            ...
            (c = parseFloat(c)),
                ...
                c || d
                    ? ((c *= ir),
                      ...
                      (n = Math.sin(c - d) * -m),
                      (a = Math.cos(c - d) * m),
                      d && ((p *= ir), (s = Math.tan(d - p)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), p && ((s = Math.tan(p)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
                      (r = ha(r)),
                      (i = ha(i)),
                      (n = ha(n)),
                      (a = ha(a)))
                    : ((r = _), (a = m), (i = n = 0)),
                ((x && !~(l + '').indexOf('px')) || (M && !~(f + '').indexOf('px'))) && ((x = Yd(g, 'x', l, 'px')), (M = Yd(g, 'y', f, 'px'))),
                (v || y || T || b) && ((x = ha(x + v - (v * r + y * n) + T)), (M = ha(M + y - (v * i + y * a) + b))),
                (u || h) && ((s = g.getBBox()), (x = ha(x + (u / 100) * s.width)), (M = ha(M + (h / 100) * s.height))),
                ...
                for (c in (ze || Pd(), (this.styles = this.styles || Jd(t)), (b = this.styles.props), (this.tween = i), e))
                    if ('autoRound' !== c && ((o = e[c]), !dt[c] || !$b(c, e, i, n, t, a)))
                        if (((l = typeof o), (f = gr[c]), 'function' === l && (l = typeof (o = o.call(i, n, t, a))), 'string' === l && ~o.indexOf('random(') && (o = nb(o)), f)) f(this, t, c, o, i) && (T = 1);
                            ...
                            (s = (getComputedStyle(t).getPropertyValue(c) + '').trim()), (o += ''), (At.lastIndex = 0), At.test(s) || ((d = Xa(s)), (p = Xa(o))), p ? d !== p && (s = Yd(t, c, s, p) + p) : d && (o += d), this.add(x, 'setProperty', s, o, n, a, 0, 0, c), w.push(c), b.push(c, x[c]);
                        else if ('undefined' !== l) {
                            if (
                                (M && c in M ? ((s = 'function' == typeof M[c] ? M[c].call(i, n, t, a) : M[c]), r(s) && ~s.indexOf('random(') && (s = nb(s)), Xa(s + '') || (s += V.units[c] || Xa(_r(t, c)) || ''), '=' === (s + '').charAt(1) && (s = _r(t, c))) : (s = _r(t, c)),
                                (h = parseFloat(s)),
                                (_ = 'string' === l && '=' === o.charAt(1) && o.substr(0, 2)) && (o = o.substr(2)),
                                (u = parseFloat(o)),
                                c in ur &&
                                    ('autoAlpha' === c && (1 === h && 'hidden' === _r(t, 'visibility') && u && (h = 0), b.push('visibility', x.visibility), Vd(this, x, 'visibility', h ? 'inherit' : 'hidden', u ? 'inherit' : 'hidden', !u)),
                                    'scale' !== c && 'transform' !== c && ~(c = ur[c]).indexOf(',') && (c = c.split(',')[0])),
                                (m = c in er))
                            )
                                if ((this.styles.save(c), g || (((v = t._gsap).renderTransform && !e.parseTransform) || Tr(t, e.parseTransform), (y = !1 !== e.smoothOrigin && v.smooth), ((g = this._pt = new me(this._pt, x, hr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)), 'scale' === c))
                                    (this._pt = new me(this._pt, v, 'scaleY', v.scaleY, (_ ? ja(v.scaleY, _ + u) : u) - v.scaleY || 0, sd)), (this._pt.u = 0), w.push('scaleY', c), (c += 'X');
                                else {
